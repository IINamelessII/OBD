...
## Метод главных компонент (Саша)
https://habr.com/post/304214/

## Технический анализ (Олег)
https://binguru.net/texnicheskij-analiz-2665

## Вкратце ещё 10 методов
https://habr.com/company/iticapital/blog/262155/

1. ### Метод С4.5 (Саша)
1. ### Метод к-средних (Олег)
1. ### Метод опорных векторов (Саша)
1. ### Алгоритм Apriori (Олег)
1. ### EM-алгоритм (Саша)
1. ### PageRank (Олег)
1. ### AdaBoost (Саша)
1. ### Алгоритм k-ближайших соседей (kNN) (Олег)
1. ### Наивный байесовский классификатор (Саша)
1. ### Алгоритм CART (Олег)
